$(document).ready(function() {
	...
	Backstretch Images
	==============================================*/
	$.backstretch('/static/assets/header-bg.jpg');

	$('body').append('<img class="preload-image" src="/static/assets/contact-bg.jpg" style="display:none;"/>');
	...
	$('#about').waypoint(function(direction){
		...
		if (direction=='down'){
			$.backstretch('/static/assets/contact-bg.jpg');
		}else{
			$.backstretch('/static/assets/header-bg.jpg');
		}
	});
